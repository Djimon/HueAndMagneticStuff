...
public class SpriteOutline : MonoBehaviour
{
    ...
    public Color OutlineColor { get { return _outlineColor; } set { _outlineColor = value; UpdateOutline(); } }

    [SerializeField, Range(0, 2)]
    private int _outlineSize = 1;
    public int OutlineSize { get { return _outlineSize; } set { _outlineSize = value; UpdateOutline(); } }
    ...
    private void UpdateOutline()
    {
        ...
        MaterialPropertyBlock mpb = new MaterialPropertyBlock(); // jedes Objekt eigener shader
        _spriteRenderer.GetPropertyBlock(mpb);
        mpb.SetColor("_OutlineColor", _outlineColor); //input
